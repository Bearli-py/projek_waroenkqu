...
END OF JAVASCRIPT
==============================================
Semua interaksi sudah lengkap!
Yang sudah dibuat:
1. Mobile menu toggle (hamburger)
2. Filter galeri berdasarkan kategori
3. Filter menu berdasarkan kategori
4. Popup modal detail menu dengan data lengkap
5. Smooth scroll (bonus)
6. Scroll to top button (bonus - optional)

Kalau ada yang kurang atau perlu ditambah, tinggal edit bagian yang sesuai.
*/