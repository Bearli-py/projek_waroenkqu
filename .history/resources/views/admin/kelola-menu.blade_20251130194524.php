...
<section>
    ...
    {{-- Lanjutkan: Nasi Goreng, Rawon Daging, Soto Ayam, Mie Goreng Jawa, Lalapan Telur --}}
    {{-- (pakai block yang sama, tinggal ganti nama, kategori, deskripsi, harga, dan id di editMenu()/deleteMenu()) --}}
</section>
