...
<div class="page-container">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('admin.tentang') }}">
                <img src="{{ asset('images/icon/tentang-hitam.png') }}" alt="Tentang">
                <span>Tentang</span>
            </a>
        </nav>
    </aside>
    ...
    <div class="content-wrapper">
        ...
        <section class="gallery-grid" id="galleryGrid">
            ...
            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/mie goreng.png') }}" alt="Makanan 5">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/kwetiau.png') }}" alt="Makanan 6">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/lalapan empal.png') }}" alt="Makanan 7">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/lalapan telur.png') }}" alt="Makanan 8">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/lalapan ayam.png') }}" alt="Makanan 9">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/lalapan tempe n tahu.png') }}" alt="Makanan 10">
                <div class="gallery-badge">Makanan</div>
            </article>

            {{-- ====== KATEGORI MINUMAN ====== --}}
            <article class="gallery-item" data-category="minuman">
                <img src="{{ asset('images/menu/kopi.png') }}" alt="Minuman 1">
                <div class="gallery-badge">Minuman</div>
            </article>

            <article class="gallery-item" data-category="minuman">
                <img src="{{ asset('images/menu/es teh.png') }}" alt="Minuman 2">
                <div class="gallery-badge">Minuman</div>
            </article>

            <article class="gallery-item" data-category="minuman">
                <img src="{{ asset('images/menu/es jeruk.png') }}" alt="Minuman 3">
                <div class="gallery-badge">Minuman</div>
            </article>

            {{-- ====== KATEGORI SUASANA ====== --}}
            <article class="gallery-item" data-category="suasana">
                <img src="{{ asset('images/warung/dalam1.png') }}" alt="Suasana 1">
                <div class="gallery-badge">Suasana</div>
            </article>

            <article class="gallery-item" data-category="suasana">
                <img src="{{ asset('images/warung/dalam2.png') }}" alt="Suasana 2">
                <div class="gallery-badge">Suasana</div>
            </article>

            <article class="gallery-item" data-category="suasana">
                <img src="{{ asset('images/warung/luar-siang.png') }}" alt="Suasana 3">
                <div class="gallery-badge">Suasana</div>
            </article>

            <article class="gallery-item" data-category="suasana">
                <img src="{{ asset('images/warung/luar-sore.png') }}" alt="Suasana 4">
                <div class="gallery-badge">Suasana</div>
            </article>
        </section>
