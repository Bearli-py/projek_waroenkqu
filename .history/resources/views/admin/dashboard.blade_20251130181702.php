...
<head>
    ...
    <style>
        ...
        .stat-card {
            ...
            justify-content: space-between;
            color: #fff;
            box-shadow: 0 10px 24px rgba(0,0,0,0.18);    {{-- Shadow lembut --}}
        }
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <div class="sidebar-item sidebar-item--active">
                    <img src="{{ asset('images/icon/mpng') }}" 
                         alt="Overview Icon"
            ...
            <header class="top-bar">
                <div class="top-left">
                    ...
                    <button type="button" class="menu-button" id="menuToggle">
                        ...
                        <img src="{{ asset('images/icon/menu.png') }}" 
                             alt="Menu"
                             class="menu-icon">
                    </button>
                ...
                <form method="POST" action="#">
                    ...
                    <button type="submit" class="btn-logout">
                        ...
                        <img src="{{ asset('images/icon/keluar.png') }}" 
                             alt="Keluar"
            ...
            <section class="stats-row">
                ...
                <article class="stat-card red">
                    <div class="stat-header">
                        ...
                        <span class="stat-value">10</span> {{-- Contoh angka static --}}
                    </div>
                </article>
                ...
                <article class="stat-card yellow">
                    <div class="stat-header">
                        <div class="stat-left">
                            <img src="{{ asset('images/icon/galeri putih.png') }}" 
                                 alt="Ikon Galeri"
                                 class="stat-icon">
                ...
                <article class="stat-card green">
                    <div class="stat-header">
                        <div class="stat-left">
                            <img src="{{ asset('images/icon/testimoni putih.png') }}" 
                                 alt="Ikon Testimoni"
                                 class="stat-icon">
            ...
            <section class="content-box">
                ...
                <div class="content-buttons">
                    ...
                    <button type="button" class="content-btn red">
                        <img src="{{ asset('images/icon/menu putih.png') }}" 
                             alt="Kelola Menu"
                             class="content-btn-icon">
                        <span>Kelola Menu</span>
                    </button>

                    {{-- Tombol Kelola Galeri --}}
                    ...
                    {{-- Tombol Kelola Testimoni --}}
                    <button type="button" class="content-btn red">
                        <img src="{{ asset('images/icon/testimoni putih.png') }}" 
                             alt="Kelola Testimoni"
                             class="content-btn-icon">
