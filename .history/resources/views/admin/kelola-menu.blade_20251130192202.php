...
<head>
    ...
    <style>
        ...
        /* BATASI ukuran icon logout biar kecil & rapi */
.logout-icon {
    width: 14px;      /* ubah 14 → 16 kalau mau agak besar */
    height: 14px;
    object-fit: contain;
}
    ...
    <header class="top-bar">
        ...
        <form method="POST" action="#">
            ...
            <button type="submit" class="btn-logout">
                ...
                <img src="{{ asset('images/icon/logout merah.png') }}" alt="Keluas" class="logout merah-icon">
            Keluar
            </button>
        </form>
    </header>
