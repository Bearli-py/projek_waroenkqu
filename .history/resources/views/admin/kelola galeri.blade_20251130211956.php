...
<head>
    ...
    <style>
        ...
        .sidebar-logo-icon {
            width: 40px;                            /* Perbesar logo agar jelas */
            height: 40px;
            object-fit: contain;
        }
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-logo">
                {{-- Logo admin, bebas diganti sesuai file logo kamu --}}
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('admin.gallery') }}" class="sidebar-item sidebar-item--active">
            ...
            <a href="{{ route('admin.testimoni') }}" class="sidebar-item">
                <img src="{{ asset('images/icon/testimoni hitam.png') }}" class="sidebar-item-icon" alt="">
                <span>Testimoni</span>
            </a>
        </nav>
    </aside>
    ...
    <header class="top-bar">
        <div class="top-left">
            ...
            <button type="button" class="menu-button" id="menuToggle">
                <img src="{{ asset('images/icon/menu hitam.png') }}" alt="Menu" class="menu-icon">
            </button>
        </div>
    ...
    <div class="content-wrapper">
        ...
        <section class="gallery-grid" id="galleryGrid">
            ...
            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/makanan-1.jpg') }}" alt="Makanan 1">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/makanan-2.jpg') }}" alt="Makanan 2">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/makanan-3.jpg') }}" alt="Makanan 3">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/makanan-4.jpg') }}" alt="Makanan 4">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/makanan-5.jpg') }}" alt="Makanan 5">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/makanan-6.jpg') }}" alt="Makanan 6">
                <div class="gallery-badge">Makanan</div>
            </article>

            {{-- ====== KATEGORI MINUMAN ====== --}}
            <article class="gallery-item" data-category="minuman">
                <img src="{{ asset('images/menu/minuman-1.jpg') }}" alt="Minuman 1">
                <div class="gallery-badge">Minuman</div>
            </article>

            <article class="gallery-item" data-category="minuman">
                <img src="{{ asset('images/menu/minuman-2.jpg') }}" alt="Minuman 2">
                <div class="gallery-badge">Minuman</div>
            </article>

            <article class="gallery-item" data-category="minuman">
                <img src="{{ asset('images/menu/minuman-3.jpg') }}" alt="Minuman 3">
                <div class="gallery-badge">Minuman</div>
            </article>

            <article class="gallery-item" data-category="minuman">
                <img src="{{ asset('images/menu/minuman-4.jpg') }}" alt="Minuman 4">
                <div class="gallery-badge">Minuman</div>
            </article>
