...
.testi-form-title {
    ...
    margin-bottom: 18px;
        ...
        .testi-avatar {
            width: 48px;
            height: 48px;
            border-radius: 50%;                    /* Tetap bentuk lingkaran */
    ...
    <div class="modal-actions">
        ...
        <section class="testi-grid">
            ...
            <article class="testi-card">
                <div class="testi-card-header">
                    ...
                    <div class="testi-info">
                        ...
                        <div class="testi-date">7 bulan yang lalu</div>
                    </div>
                </div>
                ...
                <div class="testi-text">
                    "Menu lalapannya lengkap dan murah meriah. Cocok buat anak kos kayak saya. Sambalnya mantap, bikin ketagihan!"
                </div>
            </article>
            ...
            <article class="testi-card">
                <div class="testi-card-header">
                    {{-- Foto profil pengguna --}}
                        <img src="{{ asset('images/icon/user.png') }}" 
                            ...
                            class="testi-avatar">
                    <div class="testi-info">
                        <div class="testi-name">Bambang Suryanto</div>
                        <div class="testi-date">2 minggu yang lalu</div>
                    </div>
                </div>
                ...
                <div class="testi-text">
                    "Tempat makan yang pas buat keluarga. Anak-anak suka banget sama nasi gorengnya. Pelayanannya juga oke!"
                </div>
            </article>
