    ...
    <style>
        ...
        */
        ...
        .admin-login-card {
            ...
            width: 100%;     
            max-height: 450px;      /* ← BATAS TINGGI CARD */                        /* Lebar penuh sampai max-width */
        }

        /* KOLUM KIRI: FORM LOGIN */
        .admin-login-left {
            flex: 1;              /* Ambil 50% lebar card (sama dengan kanan) */
            padding: 30px 32px;   /* Ruang di dalam card kiri */
        ...
        .admin-login-right {
            ...
            min-height: 0;          /* ← JANGAN PAKSA MIN HEIGHT BESAR */
        }
        ...
        .admin-login-right img {
            ...
            max-height: 450px;      /* ← SAMA DENGAN CARD */
        }
        ...
        */
        ...
        @media (max-width: 768px) {
            .admin-login-card {
                ...
                max-width: 95%;
                max-height: none;     /* biar bebas di mobile */
            }
...
<body>
    ...
    @csrf
                ...
                @error('login')
                    <div style="color:#B33939; font-size: 13px; margin-bottom: 20px;">
                        {{ $message }}
                    </div>
                @enderror
