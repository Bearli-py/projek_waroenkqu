...
<div class="page-container">
    ...
    <div class="content-wrapper">
        ...
        <section class="gallery-grid" id="galleryGrid">
            ...
            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/rawon.jpg') }}" alt="Makanan 2">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/soto daging.jpg') }}" alt="Makanan 3">
                <div class="gallery-badge">Makanan</div>
            </article>

            <article class="gallery-item" data-category="makanan">
                <img src="{{ asset('images/menu/nasi goreng.jpg') }}" alt="Makanan 4">
                <div class="gallery-badge">Makanan</div>
            </article>
