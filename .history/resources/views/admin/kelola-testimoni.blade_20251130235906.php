...
<div class="page-container">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            {{-- Galeri --}}
            <a href="{{ route('admin.gallery') }}" class="sidebar-item">
            ...
            <a href="{{ route('admin.testimoni') }}" class="sidebar-item sidebar-item--active">
                <img src="{{ asset('images/icon/testimoni hitam.png') }}" 
                     class="sidebar-item-icon" 
                     alt="Testimoni">
                <span>Testimoni</span>
            </a>
        ...
        <section class="testi-grid">
            ...
            <article class="testi-card">
                ...
                <div class="testi-text">
                    Penataan akhr kalau? Praesent tornas, labum molestias bongsl tiglrp maretra nyjbuk luting xulotss. Etiam salm brak tornas, lumslurli. Serrga dosta asua leel.
                </div>
            </article>
            ...
            <article class="testi-card">
                ...
                <div class="testi-text">
                    Porean masa lugh, lagiann regar vaert. Malabulas datum sorveau riatodi. Mangan bi nam sebleg lius. Probsis Musing jdio leanuas ohlnaa maleem hilk benenak.
                </div>
            </article>
            ...
            <article class="testi-card">
                ...
                <div class="testi-text">
                    Akpoh aik vinal, igo jobit-jolirneg. Lukirug cekkor wentyp heran-loraj tagi vilot vorlali rotokang ralekag jerek vorak virrgh Himal rishyt ngop.
                </div>
            </article>
            ...
            <article class="testi-card">
                ...
                <div class="testi-text">
                    Onsleh bagot tigh relyen chod id talerh oyang dhina nyaha gareh tung riveks. Bakot toleara yang rivahs giknas, taul rajlah bolan.
                </div>
            </article>
            ...
            <article class="testi-card">
                ...
                <div class="testi-text">
                    Gureh sakai ving dimak. Royons rita eksere, bekarid bukunud gala yang eloks. Mahulad gergingan mak suparak merag teloks.
                </div>
            </article>
            ...
            <article class="testi-card">
                ...
                <div class="testi-text">
                    Warning fa hulh yairi tambarar stati bategad Kiuh ekukuerob sukun rirek viir dilevaras yan houq. Rekormendasi touli.
                </div>
            </article>
...
<div class="modal-backdrop" id="modalBackdrop">
    <div class="modal-card">
        <div class="modal-title">Tambah Testimoni Baru</div>

        {{-- Form group: Nama Pelanggan --}}
        ...
        {{-- Form group: Rating Bintang --}}
        <div class="rating-group">
            <label class="form-label">Rating</label>
            <div class="star-rating" id="starRating">
                {{-- 5 bintang interaktif yang bisa diklik --}}
...
<script>
    ...
    // ==============================
    // B. TOGGLE MODAL TAMBAH TESTIMONI
    // ==============================
    ...
    // Klik tombol "Tambah Testimoni" → tampilkan modal
    if (btnShowModal && modalBackdrop) {
