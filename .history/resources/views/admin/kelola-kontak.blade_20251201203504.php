    ...
    <style>
        ...
        */
        ...
        .top-bar {
            ...
            box-shadow: 0 2px 8px rgba(0, 0, 0, 0.04); /* Shadow halus */
            position: sticky;
            top: 0;
            z-index: 800; /* Di bawah sidebar & overlay */
        }

        /* Container kiri top bar */
        .top-left {
            display: flex;
            align-items: center;
            gap: 16px;
        ...
        .btn-logout:hover {
            background-color: #B33939; /* Background merah saat hover */
            color: #FFFFFF;
            transform: translateY(-2px); /* Lift effect */
            box-shadow: 0 4px 12px rgba(179, 57, 57, 0.3);
        }
    ...
    <div class="top-bar">
        <div class="top-left">
            ...
            <button class="menu-button" id="menuButton" onclick="toggleSidebar()">
                <img src="images/icon/overview.png" alt="Menu" class="menu-icon">
            </button>
        </div>
        ...
        <button class="btn-logout" onclick="logout()">
            <img src="images/icon/keluar merah.png" alt="Keluar" class="btn-logout-icon">
            <span>Keluar</span>
        </button>
    </div>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-header">
            <div class="sidebar-logo">
                <img src="images/icon/logo1.png" alt="Logo Waroenk Qu" class="sidebar-logo-icon">
        ...
        <nav class="sidebar-menu">
            <!-- Link ke Overview -->
            <a href="overview.html" class="sidebar-item">
                <img src="images/icon/statistic hitam.png" class="sidebar-item-icon" alt="">
                <span>Overview</span>
            </a>

            <!-- Link ke Kelola Menu -->
            <a href="kelola-menu.html" class="sidebar-item">
                <img src="images/icon/menu hitam.png" class="sidebar-item-icon" alt="">
                <span>Menu</span>
            </a>

            <!-- Link ke Kelola Galeri -->
            <a href="kelola-galeri.html" class="sidebar-item">
                <img src="images/icon/galeri hitam.png" class="sidebar-item-icon" alt="">
                <span>Galeri</span>
            </a>

            <!-- Link ke Kelola Testimoni -->
            <a href="kelola-testimoni.html" class="sidebar-item">
                <img src="images/icon/testi hitam.png" class="sidebar-item-icon" alt="">
                <span>Testimoni</span>
            </a>

            <!-- Link ke Kelola Tentang -->
            <a href="kelola-tentang.html" class="sidebar-item">
                <img src="images/icon/tentang hitam.png" class="sidebar-item-icon" alt="">
                <span>Tentang</span>
            </a>

            <!-- Link ke Kelola Kontak (AKTIF) -->
            ...
            <div class="social-items">
                ...
                <div class="social-item">
                    ...
                    <input 
                        ...
                        class="input-text" 
                        id="social-instagram"
                        value="http://instagram.com/WaroenkQu" 
