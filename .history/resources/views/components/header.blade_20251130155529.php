...
Cara kerja:
- style="..." = CSS langsung di HTML
- width: 70px !important = logo BESAR PASTI!
- display: flex + align-items: center = LURUS SEJAJAR!
- border-bottom saat active = garis bawah menu merah
