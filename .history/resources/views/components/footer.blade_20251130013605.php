        ...
        <div class="footer-content">
            ...
            <div class="footer-column">
                ...
                <div class="footer-info-new">
                    ...
                    <div class="info-item-new">
                        ...
                        GANTI DENGAN NOMOR WHATSAPP ASLI WARUNG!
            ...
            <div class="footer-column">
                ...
                <div class="footer-info-new">
                    ...
                    GANTI DENGAN JAM BUKA ASLI WARUNG!
...
CATATAN PENTING:
==============================================
1. Copyright CUMA ADA 1 tempat: Di kolom "Ikuti Kami" (di bawah icon sosmed)
2. TIDAK ADA copyright terpisah di bawah footer content
3. Kalau ada <div class="footer-bottom"> di file ini, HAPUS!
4. File icon yang WAJIB ada:
   - public/images/icon/instagram.png (32x32px)
   - public/images/icon/facebook.png (32x32px)
   - public/images/icon/phone.png (18x18px)
   - public/images/icon/email.png (18x18px)
   - public/images/icon/whatsapp.png (18x18px)
5. GANTI semua URL, nomor, email, alamat, jam buka dengan data asli warung!
--}}