...
Ini bagian paling bawah yang ada info warung, link cepat, dan kontak.
...
<footer class="footer">
    ...
    <div class="container">
        ...
        - Kolom 1: Info warung (logo, tagline)
        - Kolom 2: Link cepat (Beranda, Menu, dll)
        ...
        <div class="footer-content">
            ...
            <div class="footer-column">
                ...
                <div class="footer-contact">
                    ...
                    <div class="contact-item">
                        <img src="{{ asset('images/icon/map.png') }}" alt="Location">
                        <span>Jl. Raya Bondowoso No. 123</span>
                    </div>
                </div>
