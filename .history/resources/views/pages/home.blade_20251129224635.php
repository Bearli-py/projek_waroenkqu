...
=================================
Tampilkan 4 menu favorit dengan:
- Foto menu
- Nama menu
- HARGA (warna merah #B33939)
- Hover: foto zoom in
shadow halus biar rapi
--}}
<section class="featured-menu">
    <div class="container">
        ...
        Pakai CSS Grid buat atur layout responsive
        --}}
        <div class="menu-grid-featured">
            {{-- 
            MENU ITEM 1: NASI RAWON
            Kotak putih dengan shadow halus, tanpa border
            Background putih, border-radius buat sudut melengkung
            Hover: foto zoom in (overflow hidden)
            --}}
            <div class="menu-card-featured">
                {{-- 
                WRAPPER FOTO
                overflow: hidden biar foto zoom gak keluar dari kotak
                Foto bakal punya efek zoom saat hover (di CSS)
                Kalau dihapus: Foto zoom bakal keluar dari kotak (jelek)
                --}}
                <div class="menu-image-wrapper">
                    <img src="{{ asset('images/menu/rawon.png') }}" alt="Nasi Rawon" class="menu-image">
                </div>
                {{-- 
                INFO MENU (di bawah foto)
                Berisi nama menu dan harga
                Padding biar gak nempel sama foto
                --}}
                <div class="menu-info">
                    {{-- Nama menu (font Poppins) --}}
                    <h3 class="menu-name">Nasi Rawon</h3>
                    {{-- Harga menu (warna merah #B33939) --}}
            ...
            <div class="menu-card-featured">
                <div class="menu-image-wrapper">
                    <img src="{{ asset('images/menu/nasi goreng.png') }}" alt="Nasi Goreng Jawa" class="menu-image">
                </div>
                <div class="menu-info">
