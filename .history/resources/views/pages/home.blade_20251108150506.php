...
<section class="hero">
    ...
    <div class="hero-tagline">
        <img src="{{ asset('images/icons/sparkle.png') }}" alt="sparkle" style="width: 24px; height: 24px; vertical-align: middle; margin-right: 8px;">
        <span style="color: #5A8C6B;">Cita Rasa Autentik</span>, 
        <span style="color: #E96C3A;">Harga Bersahabat</span>
        <img src="{{ asset('images/icon/sparkling.png') }}" alt="sparkle" style="width: 24px; height: 24px; vertical-align: middle; margin-left: 8px;">
    </div>
