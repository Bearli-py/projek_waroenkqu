...
--}}
<section class="hero" style="background-image: url('{{ asset('images/warung/dalam2.png') }}'); background-size: cover; background-position: center; min-height: 600px; display: flex; align-items: center; position: relative; padding: 0;">
    ...
    --}}
    <div class="container" style="position: relative; z-index: 2; max-width: 1200px; margin: 0 auto; padding: 0 20px; width: 100%;">
