...
--}}
<section class="page-header" style="padding-bottom: 20px;">
    <div class="container">
        {{-- JUDUL HALAMAN --}}
        <h1 class="page-title">Galeri Waroenk Qu</h1>
        {{-- SUBJUDUL --}}
        <p class="page-subtitle" style="margin-bottom: 5px;">Lihat koleksi foto makanan, minuman, dan suasana warung kami</p>
    </div>
</section>
