...
<section class="page-header">
    <div class="container">
        <h1 class="page-title">Menu Waroenk Qu</h1>
        <p class="page-subtitle">Pilihan menu lezat dengan harga terjangkau</p>
    </div>
</section>

{{-- 
=================================
SECTION 2: FILTER KATEGORI MENU
=================================
    ...
    <div class="container">
        ...
        <div class="filter-buttons">
            ...
            <button class="filter-btn active" data-filter="all">
                <img src="{{ asset('images/icon/menu merah.png') }}" alt="Semua" class="filter-icon">
                <span>Semua</span>
            </button>
