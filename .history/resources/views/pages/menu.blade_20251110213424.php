...
<section class="section">
    ...
    <div class="menu-grid">
        ...
        <div class="menu-card" data-category="makanan">
            <div class="menu-image">
                <img src="{{ asset('images/menu/lalapan tahu n tempe.jpg') }}" alt="Nasi Lalapan Tahu Tempe">
            </div>
            <div class="menu-content">
        ...
        <div class="menu-card" data-category="makanan">
            <div class="menu-image">
                <img src="{{ asset('images/menu/nasgor.jpg') }}" alt="Nasi Goreng Jawa">
            </div>
            <div class="menu-content">
        ...
        <div class="menu-card" data-category="minuman">
            <div class="menu-image">
                <img src="{{ asset('images/menu/es jeruk.jpg') }}" alt="Jeruk">
            </div>
            <div class="menu-content">
