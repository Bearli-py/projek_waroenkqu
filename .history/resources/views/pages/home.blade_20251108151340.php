...
<section class="hero">
    ...
    <div class="hero-tagline">
        <img src="{{ asset('images/icon/star.png') }}" alt="sparkle" style="width: 35px; height: 35px; vertical-align: middle; margin-right: 5px;">
        <span style="color: #5A8C6B;">Cita Rasa Autentik</span>, 
        <span style="color: #E96C3A;">Harga Bersahabat</span>
        <img src="{{ asset('images/icon/star.png') }}" alt="sparkle" style="width: 35px; height: 35px; vertical-align: middle; margin-left: 5px;">
    </div>
