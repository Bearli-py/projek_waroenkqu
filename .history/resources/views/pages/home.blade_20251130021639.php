...
<section class="hero">
    ...
    <div class="container">
        ...
        --}}
        <div class="hero-content" style="text-align: left !important; max-width: 700px !important; margin: 0 !important; margin-left: 0 !important;">
            {{-- 
            JUDUL UTAMA
            ...
            --}}
            <h1 class="hero-title" style="text-align: left !important;">
            ...
            --}}
            <p class="hero-subtitle" style="text-align: left !important;">
            ...
            --}}
            <div class="hero-buttons" style="display: flex !important; justify-content: flex-start !important; gap: 20px;">
                {{-- 
                TOMBOL 1: LIHAT MENU
