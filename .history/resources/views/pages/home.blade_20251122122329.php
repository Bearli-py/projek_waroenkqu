...
<section class="hero-home">
    <div class="hero-home-image" style="background-image: url('{{ asset('images/warung/dalam2.png') }}');"></div>
...
<section class="featured-menu">
    ...
    <div class="featured-card">
        <div class="featured-image" data-menu-name="{{ $menu['name'] }}">
            <img src="{{ asset($menu['image']) }}" alt="{{ $menu['name'] }}">
        </div>
        <div class="featured-info">
            <h3>{{ $menu['name'] }}</h3>
            <p class="featured-price">Rp {{ number_format($menu['price'], 0, ',', '.') }}</p>
        </div>
    </div>
    @endforeach
</div>
