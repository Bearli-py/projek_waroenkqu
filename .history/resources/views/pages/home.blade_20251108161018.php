...
<section class="hero-carousel">
    <div class="carousel-container">
        ...
        <div class="carousel-slide active">
            <div class="carousel-image" style="background-image: url('{{ asset('images/warung/luar siang.png') }}');"></div>
        ...
        <div class="carousel-slide">
            <div class="carousel-image" style="background-image: url('{{ asset('images/warung/slide-2.jpg') }}');"></div>
            <div class="carousel-overlay"></div>
            <div class="carousel-content">
        ...
        <!-- Slide 3 -->
        <div class="carousel-slide">
            <div class="carousel-image" style="background-image: url('{{ asset('images/slides/slide-3.jpg') }}');"></div>
            <div class="carousel-overlay"></div>
            <div class="carousel-content">
