...
<section class="section">
    ...
    <div class="filter-tabs">
        <button class="filter-tab active" onclick="filterMenu('all')" data-filter="all">
            <img src="{{ asset('images/icons/kamera.jpg') }}" alt="Semua" class="tab-icon">
            Semua
        </button>
        <button class="filter-tab" onclick="filterMenu('makanan')" data-filter="makanan">
            <img src="{{ asset('images/icons/makanan.jpg') }}" alt="Makanan" class="tab-icon">
            Makanan
        </button>
        <button class="filter-tab" onclick="filterMenu('minuman')" data-filter="minuman">
            <img src="{{ asset('images/icons/minuman.jpg') }}" alt="Minuman" class="tab-icon">
            Minuman
        </button>
    </div>
    ...
    <div class="menu-grid">
        ...
        <div class="menu-card" data-category="makanan">
            <div class="menu-image">
                <img src="{{ asset('images/menu/soto-ayam.jpg') }}" alt="Nasi Soto Ayam">
                <span class="menu-badge popular">Populer</span>
            </div>
            <div class="menu-content">
...
### **✅ Deskripsi Baru (Fun & Relate):**
- Rawon: "bikin sendok ga mau berhenti" 😄
- Soto Ayam: "auto semangat kuliah (atau minimal semangat hidup dikit)" 😂
- Lalapan Telur: "makan berasa mevvah" ✨
- Teh Tawar: "buat yang lagi ngirit gula atau baru putus cinta" 💔
- Pop Ice: "throwback ke masa SD" 🎉

### **✅ Menu Baru:**
- **Kwetiau Goreng** (Rp 12.000) ditambahkan!
...
Tambahkan foto untuk menu baru:
```
C:\laragon\www\waroenk-qu\public\images\menu\
└── kwetiau-goreng.jpg  ← FOTO BARU