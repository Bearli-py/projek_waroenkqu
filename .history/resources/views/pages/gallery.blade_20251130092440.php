...
--}}
<section style="background-color: #fff; padding: 60px 0 40px; text-align: center;">
    <div class="container">
        
        {{-- JUDUL --}}
        <h1 style="font-family: 'Playfair Display', serif; font-size: 42px; color: #B33939; margin-bottom: 10px;">
            Galeri Waroenk Qu
        </h1>
        
        {{-- SUBJUDUL --}}
        <p style="font-family: 'Poppins', sans-serif; font-size: 18px; color: #666; margin-bottom: 25px;">
            Lihat koleksi foto makanan, minuman, dan suasana warung kami
        </p>
        
        {{-- BUTTON KATEGORI --}}
        <div style="display: flex; justify-content: center; align-items: center; gap: 12px; flex-wrap: wrap; margin-top: 0;">
...
<section class="gallery-section">
    <div class="container">
        ...
        <div class="filter-buttons-new">
            ...
            Icon suasana kuning
            --}}
            <button class="filter-btn-new red" data-filter="suasana">
                <img src="{{ asset('images/icon/suasana kuning.png') }}" alt="Suasana" class="filter-icon-new">
                <span>Suasana</span>
            </button>
        </div>
...
{{-- JAVASCRIPT FILTER GALERI (INLINE) --}}
<script>
document.addEventListener('DOMContentLoaded', function() {
    console.log('Gallery filter loaded!'); // Untuk debug
    
    const filterButtons = document.querySelectorAll('.filter-btn-new');
    const galleryItems = document.querySelectorAll('.gallery-item');
    
    console.log('Buttons:', filterButtons.length); // Debug
    console.log('Items:', galleryItems.length); // Debug
