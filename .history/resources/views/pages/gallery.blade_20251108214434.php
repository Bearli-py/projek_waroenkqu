...
<!-- Filter Tabs -->
    ...
    <div class="gallery-grid">
        ...
        <div class="gallery-item" data-category="minuman">
            <img src="{{ asset('images/menu/es teh.jpg') }}" alt="Teh Manis Es/Hangat">
            <div class="gallery-overlay">
                <div class="gallery-info">
                    <h3>Teh Manis Es/Hangat</h3>
        ...
        <div class="gallery-item" data-category="minuman">
            <img src="{{ asset('images/menu/teh tawar.jpg') }}" alt="Teh Tawar Es/Hangat">
            <div class="gallery-overlay">
                <div class="gallery-info">
                    <h3>Teh Tawar Es/Hangat</h3>
                    <p>Teh polos tanpa gula, pas buat teman makan berat</p>
                </div>
            </div>
        </div>
        ...
        <div class="gallery-item" data-category="minuman">
            ...
            <div class="gallery-overlay">
                <div class="gallery-info">
                    <h3>Kopi Panas</h3>
                    <p>Kopi hitam hangat dengan aroma kuat dan rasa khas warung</p>
                </div>
            </div>

        <div class="gallery-item" data-category="minuman">
            <img src="{{ asset('images/menu/popice.jpg') }}" alt="Pop Ice">
            <div class="gallery-overlay">
                <div class="gallery-info">
                    <h3>Pop Ice</h3>
                    <p>Minuman es rasa buah yang manis dan nyegerin, favorit anak muda</p>
                </div>
            </div>
        ...
        <div class="gallery-item" data-category="minuman">
            ...
            <div class="gallery-overlay">
                <div class="gallery-info">
                    <h3>Nutrisari</h3>
                    <p>Minuman jeruk instan dengan rasa segar dan kaya vitamin C</p>
                </div>
            </div>
    </div>
