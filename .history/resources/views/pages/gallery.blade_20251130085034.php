...
<section style="background-color: #fff; padding: 60px 0 40px; text-align: center;">
    <div class="container">
        ...
        {{-- JUDUL --}}
        <h1 style="font-family: 'Playfair Display', serif; font-size: 42px; color: #B33939; margin-bottom: 15px;">
            Galeri Waroenk Qu
        </h1>
        
        {{-- SUBJUDUL --}}
        <p style="font-family: 'Poppins', sans-serif; font-size: 18px; color: #666; margin-bottom: 30px;">
...
<section class="gallery-section">
    <div class="container">
        ...
        --}}
        <div class="filter-buttons-new" style="margin-top: 25px;">
            {{-- 
