...
<section class="hero-carousel">
    <div class="carousel-container">
        ...
        <div class="carousel-slide">
            <div class="carousel-image" style="background-image: url('{{ asset('images/dalam2.jpg') }}');"></div>
            <div class="carousel-overlay"></div>
            <div class="carousel-content">
        ...
        <!-- Slide 3 -->
        <div class="carousel-slide">
            <div class="carousel-image" style="background-image: url('{{ asset('images/slides/luar sore.jpg') }}');"></div>
            <div class="carousel-overlay"></div>
            <div class="carousel-content">
