...
<section class="hero-carousel">
    <div class="carousel-container">
        ...
        <div class="carousel-slide">
            <div class="carousel-image" style="background-image: url('{{ asset('images/warung/dalam2.png') }}');"></div>
            <div class="carousel-overlay"></div>
            <div class="carousel-content">
        ...
        <!-- Slide 3 -->
        <div class="carousel-slide">
            <div class="carousel-image" style="background-image: url('{{ asset('images/warung/luar-sore.png') }}');"></div>
            <div class="carousel-overlay"></div>
            <div class="carousel-content">
...
## 📂 **ATAU... RENAME FILE FOTO:**

**Buka File Explorer:**
```
C:\laragon\www\waroenk-qu\public\images\warung\
```

**Rename file:**
- `dalam2.png` → Pindahkan ke folder `warung/`
- `luar sore.png` → Rename jadi `luar-sore.png` (ganti spasi jadi dash)

**Struktur yang BENAR:**
```
C:\laragon\www\waroenk-qu\public\images\warung\
├── dalam1.png       ✅
├── dalam2.png       ✅ (pindahkan dari images/ ke images/warung/)
└── luar-sore.png    ✅ (rename dari "luar sore.png")