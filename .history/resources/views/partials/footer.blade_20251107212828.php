        ...
        <div class="footer-item">
            ...
            <div style="display: flex; gap: 12px; margin-top: 16px; align-items: center;">
                ...
                <a href="https://wa.me/6285924171803" target="_blank" 
                   style="width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; padding: 10px; box-shadow: 0 2px 8px rgba(37, 211, 102, 0.3);"
                ...
                <a href="mailto:info@waroenkqu.com"
                   ...
                   title="Email">
                    <img src="{{ asset('images/icon/email.png') }}" alt="Email" style="width: 28px; height: 28px; filter: brightness(0) invert(1);">
                </a>
                
                <!-- Google Maps -->
                <a href="https://maps.app.goo.gl/wfNNDervvBjcxmpt6" target="_blank"
                   style="width: 48px; height: 48px; background: #f44542ff; border-radius: 12px; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; padding: 10px; box-shadow: 0 2px 8px rgba(66, 133, 244, 0.3);"
                   ...
                   title="Google Maps">
                    <img src="{{ asset('images/icon/maps.png') }}" alt="Maps" style="width: 28px; height: 28px; filter: brightness(0) invert(1);">
                </a>
                ...
                <a href="tel:+6285924171803"
                   ...
                   title="Telepon">
                    <img src="{{ asset('images/icon/phone.png') }}" alt="Phone" style="width: 28px; height: 28px; filter: brightness(0) invert(1);">
                </a>
