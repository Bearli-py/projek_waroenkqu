        ...
        <div class="footer-item">
            ...
            <div style="display: flex; gap: 12px; margin-top: 16px; align-items: center;">
                ...
                <a href="https://wa.me/6281234567890" target="_blank" 
                   ...
                   title="WhatsApp">
                    <img src="{{ asset('images/icons/whatsapp.png') }}" alt="WhatsApp" style="width: 28px; height: 28px; filter: brightness(0) invert(1);">
                </a>
                
                <!-- Instagram -->
                <a href="https://instagram.com/waroenkqu" target="_blank"
...
**📝 PERUBAHAN:**
- Icon pakai `{{ asset('images/icons/NAMA_ICON.png') }}`
- `filter: brightness(0) invert(1)` → Bikin icon jadi putih
- Hover effect lebih smooth dengan shadow
