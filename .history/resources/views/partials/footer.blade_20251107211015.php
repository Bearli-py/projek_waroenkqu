        ...
        <div class="footer-item">
            ...
            <div style="display: flex; gap: 12px; margin-top: 16px; align-items: center;">
                ...
                <a href="https://maps.app.goo.gl/wfNNDervvBjcxmpt6" target="_blank"
                   style="width: 48px; height: 48px; background: #f48f42ff; border-radius: 12px; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; padding: 10px; box-shadow: 0 2px 8px rgba(66, 133, 244, 0.3);"
