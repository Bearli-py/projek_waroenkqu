        ...
        <div class="footer-item">
            ...
            <a href="https://maps.app.goo.gl/wfNNDervvBjcxmpt6" target="_blank" 
               ...
               onmouseout="this.style.color='#FCD34D'; this.style.transform='translateX(0)'">
                <img src="{{ asset('images/icon/maps.png') }}" alt="Maps" style="width: 20px; height: 20px;">
                Lihat di Maps
            </a>
        </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                ...
                <a href="tel:+6285924171803" 
                   ...
                   onmouseout="this.style.color='white'">
                    <img src="{{ asset('images/icon/phone.png') }}" alt="Phone" style="width: 20px; height: 20px;">
                ...
                <a href="mailto:info@waroenkqu.com"
                   ...
                   onmouseover="this.style.color='#FCD34D'"
                   onmouseout="this.style.color='white'">
                    <img src="{{ asset('images/icon/email.png') }}" alt="Email" style="width: 20px; height: 20px;">
                ...
                <a href="https://wa.me/6285924171803" target="_blank"
                   ...
                   onmouseover="this.style.color='#FCD34D'"
                   onmouseout="this.style.color='white'">
                    <img src="{{ asset('images/icon/whatsapp.png') }}" alt="WhatsApp" style="width: 20px; height: 20px;">
