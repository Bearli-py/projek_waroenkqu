...
/*
PENJELASAN KENAPA ERROR TADI:
- header.blade.php pakai route('beranda')
- Tapi file web.php kosong / gak ada route bernama 'beranda'
- Laravel bingung: "Mana route beranda??"
- Error: Route [beranda] not defined

SOLUSI:
- Tambahkan route dengan ->name('beranda')
- Sekarang Laravel tau kemana arahnya!
*/